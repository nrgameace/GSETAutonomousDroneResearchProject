...
def ladder_Map1():
	OBSTACLES1. append((4 * 25, 1 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((4 * 25, 2 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((4 * 25, 3 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((3 * 25, 3 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((5 * 25, 3 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((6 * 25, 3 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((7 * 25, 3 * 25, 25 + BUFFER, 25 + BUFFER)) 

	OBSTACLES1. append((9 * 25, 1 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((9 * 25, 2 * 25, 25 + BUFFER, 25 + BUFFER)) 

	OBSTACLES1. append((1 * 25, 8 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((2 * 25, 8 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((3 * 25, 8 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((4 * 25, 8 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((5 * 25, 8 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((3 * 25, 7 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((3 * 25, 6 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((3 * 25, 9 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((3 * 25, 10 * 25, 25 + BUFFER, 25 + BUFFER)) 

	OBSTACLES1. append((7 * 25, 11 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((7 * 25, 10 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((6 * 25, 10 * 25, 25 + BUFFER, 25 + BUFFER)) 

	OBSTACLES1. append((11 * 25, 9 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((10 * 25, 9 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((10 * 25, 8 * 25, 25 + BUFFER, 25 + BUFFER)) 

	OBSTACLES1. append((8 * 25, 5 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((8 * 25, 6 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((8 * 25, 7 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((9 * 25, 5 * 25, 25 + BUFFER, 25 + BUFFER))

	OBSTACLESDRAW. append((4 * 25, 1 * 25, 25, 25)) 
	OBSTACLESDRAW. append((4 * 25, 2 * 25, 25, 25)) 
	OBSTACLESDRAW. append((4 * 25, 3 * 25, 25, 25)) 
	OBSTACLESDRAW. append((3 * 25, 3 * 25, 25, 25)) 
	OBSTACLESDRAW. append((5 * 25, 3 * 25, 25, 25)) 
	OBSTACLESDRAW. append((6 * 25, 3 * 25, 25, 25)) 
	OBSTACLESDRAW. append((7 * 25, 3 * 25, 25, 25)) 

	OBSTACLESDRAW. append((9 * 25, 1 * 25, 25, 25)) 
	OBSTACLESDRAW. append((9 * 25, 2 * 25, 25, 25)) 

	OBSTACLESDRAW. append((1 * 25, 8 * 25, 25, 25)) 
	OBSTACLESDRAW. append((2 * 25, 8 * 25, 25, 25)) 
	OBSTACLESDRAW. append((3 * 25, 8 * 25, 25, 25)) 
	OBSTACLESDRAW. append((4 * 25, 8 * 25, 25, 25)) 
	OBSTACLESDRAW. append((5 * 25, 8 * 25, 25, 25)) 
	OBSTACLESDRAW. append((3 * 25, 7 * 25, 25, 25)) 
	OBSTACLESDRAW. append((3 * 25, 6 * 25, 25, 25)) 
	OBSTACLESDRAW. append((3 * 25, 9 * 25, 25, 25)) 
	OBSTACLESDRAW. append((3 * 25, 10 * 25, 25, 25)) 

	OBSTACLESDRAW. append((7 * 25, 11 * 25, 25, 25)) 
	OBSTACLESDRAW. append((7 * 25, 10 * 25, 25, 25)) 
	OBSTACLESDRAW. append((6 * 25, 10 * 25, 25, 25)) 

	OBSTACLESDRAW. append((11 * 25, 9 * 25, 25, 25)) 
	OBSTACLESDRAW. append((10 * 25, 9 * 25, 25, 25)) 
	OBSTACLESDRAW. append((10 * 25, 8 * 25, 25, 25)) 

	OBSTACLESDRAW. append((8 * 25, 5 * 25, 25, 25)) 
	OBSTACLESDRAW. append((8 * 25, 6 * 25, 25, 25)) 
	OBSTACLESDRAW. append((8 * 25, 7 * 25, 25, 25)) 
	OBSTACLESDRAW. append((9 * 25, 5 * 25, 25, 25)) 
...
def ladder_Map2():
	...
	OBSTACLESDRAW. append((4 * 25, 2 * 25, 25, 25)) 
	OBSTACLESDRAW. append((4 * 25, 3 * 25, 25, 25)) 
	OBSTACLESDRAW. append((4 * 25, 4 * 25, 25, 25)) 
	OBSTACLESDRAW. append((3 * 25, 3 * 25, 25, 25)) 

	OBSTACLESDRAW. append((1 * 25, 8 * 25, 25, 25)) 
	OBSTACLESDRAW. append((2 * 25, 8 * 25, 25, 25)) 
	OBSTACLESDRAW. append((3 * 25, 8 * 25, 25, 25)) 
	OBSTACLESDRAW. append((2 * 25, 7 * 25, 25, 25)) 
	OBSTACLESDRAW. append((2 * 25, 9 * 25, 25, 25)) 
	OBSTACLESDRAW. append((2 * 25, 10 * 25, 25, 25)) 


	OBSTACLESDRAW. append((5 * 25, 11 * 25, 25, 25)) 
	OBSTACLESDRAW. append((5 * 25, 10 * 25, 25, 25)) 

	OBSTACLESDRAW. append((11 * 25, 9 * 25, 25, 25)) 
	OBSTACLESDRAW. append((10 * 25, 9 * 25, 25, 25)) 
	OBSTACLESDRAW. append((9 * 25, 9 * 25, 25, 25)) 
	OBSTACLESDRAW. append((9 * 25, 10 * 25, 25, 25)) 

	OBSTACLESDRAW. append((11 * 25, 3* 25, 25, 25)) 
	OBSTACLESDRAW. append((10 * 25, 3 * 25, 25, 25)) 
	OBSTACLESDRAW. append((10 * 25, 4 * 25, 25, 25)) 
	OBSTACLESDRAW. append((10 * 25, 5 * 25, 25, 25)) 
	OBSTACLESDRAW. append((10 * 25, 6 * 25, 25, 25)) 
	OBSTACLESDRAW. append((9 * 25, 5 * 25, 25, 25)) 

	OBSTACLESDRAW. append((7 * 25, 5 * 25, 25, 25)) 
	OBSTACLESDRAW. append((7 * 25, 6 * 25, 25, 25)) 
	OBSTACLESDRAW. append((7 * 25, 7 * 25, 25, 25)) 
	OBSTACLESDRAW. append((6 * 25, 7 * 25, 25, 25))


	OBSTACLES1. append((4 * 25, 1 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((4 * 25, 2 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((4 * 25, 3 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((4 * 25, 4 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((3 * 25, 3 * 25, 25 + BUFFER, 25 + BUFFER)) 

	OBSTACLES1. append((1 * 25, 8 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((2 * 25, 8 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((3 * 25, 8 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((2 * 25, 7 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((2 * 25, 9 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((2 * 25, 10 * 25, 25 + BUFFER, 25 + BUFFER)) 


	OBSTACLES1. append((5 * 25, 11 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((5 * 25, 10 * 25, 25 + BUFFER, 25 + BUFFER)) 

	OBSTACLES1. append((11 * 25, 9 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((10 * 25, 9 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((9 * 25, 9 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((9 * 25, 10 * 25, 25 + BUFFER, 25 + BUFFER)) 

	OBSTACLES1. append((11 * 25, 3* 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((10 * 25, 3 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((10 * 25, 4 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((10 * 25, 5 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((10 * 25, 6 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((9 * 25, 5 * 25, 25 + BUFFER, 25 + BUFFER)) 

	OBSTACLES1. append((7 * 25, 5 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((7 * 25, 6 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((7 * 25, 7 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((6 * 25, 7 * 25, 25 + BUFFER, 25 + BUFFER))

def ladder_Map3():
	OBSTACLESDRAW. append((1 * 25, 3 * 25, 25, 25)) 
	OBSTACLESDRAW. append((2 * 25, 3 * 25, 25, 25)) 
	OBSTACLESDRAW. append((2 * 25, 2 * 25, 25, 25)) 
	OBSTACLESDRAW. append((3 * 25, 3 * 25, 25, 25)) 
	OBSTACLESDRAW. append((4 * 25, 3 * 25, 25, 25)) 

	OBSTACLESDRAW. append((1 * 25, 9 * 25, 25, 25)) 
	OBSTACLESDRAW. append((2 * 25, 9 * 25, 25, 25)) 
	OBSTACLESDRAW. append((2 * 25, 8 * 25, 25, 25)) 

	OBSTACLESDRAW. append((4 * 25, 8 * 25, 25, 25)) 
	OBSTACLESDRAW. append((4 * 25, 7 * 25, 25, 25)) 
	OBSTACLESDRAW. append((4 * 25, 6 * 25, 25, 25)) 


	OBSTACLESDRAW. append((5 * 25, 11 * 25, 25, 25)) 
	OBSTACLESDRAW. append((5 * 25, 10 * 25, 25, 25)) 
	OBSTACLESDRAW. append((6 * 25, 10 * 25, 25, 25)) 
	OBSTACLESDRAW. append((6 * 25, 9 * 25, 25, 25)) 
	OBSTACLESDRAW. append((7 * 25, 10 * 25, 25, 25)) 
	OBSTACLESDRAW. append((8 * 25, 10 * 25, 25, 25)) 


	OBSTACLESDRAW. append((11 * 25, 7 * 25, 25, 25)) 
	OBSTACLESDRAW. append((10 * 25, 7 * 25, 25, 25)) 
	OBSTACLESDRAW. append((9 * 25, 7 * 25, 25, 25)) 
	OBSTACLESDRAW. append((9 * 25, 8 * 25, 25, 25)) 

	OBSTACLESDRAW. append((7 * 25, 1 * 25, 25, 25)) 
	OBSTACLESDRAW. append((7 * 25, 2 * 25, 25, 25)) 
	OBSTACLESDRAW. append((7 * 25, 3 * 25, 25, 25)) 
	OBSTACLESDRAW. append((7 * 25, 4 * 25, 25, 25)) 
	OBSTACLESDRAW. append((8 * 25, 4 * 25, 25, 25))

	OBSTACLES1. append((1 * 25, 3 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((2 * 25, 3 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((2 * 25, 2 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((3 * 25, 3 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((4 * 25, 3 * 25, 25 + BUFFER, 25 + BUFFER)) 

	OBSTACLES1. append((1 * 25, 9 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((2 * 25, 9 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((2 * 25, 8 * 25, 25 + BUFFER, 25 + BUFFER)) 

	OBSTACLES1. append((4 * 25, 8 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((4 * 25, 7 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((4 * 25, 6 * 25, 25 + BUFFER, 25 + BUFFER)) 


	OBSTACLES1. append((5 * 25, 11 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((5 * 25, 10 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((6 * 25, 10 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((6 * 25, 9 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((7 * 25, 10 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((8 * 25, 10 * 25, 25 + BUFFER, 25 + BUFFER)) 


	OBSTACLES1. append((11 * 25, 7 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((10 * 25, 7 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((9 * 25, 7 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((9 * 25, 8 * 25, 25 + BUFFER, 25 + BUFFER)) 

	OBSTACLES1. append((7 * 25, 1 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((7 * 25, 2 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((7 * 25, 3 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((7 * 25, 4 * 25, 25 + BUFFER, 25 + BUFFER)) 
	OBSTACLES1. append((8 * 25, 4 * 25, 25 + BUFFER, 25 + BUFFER))
